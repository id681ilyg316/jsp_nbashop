                ...
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a tabindex="-1" href="/nbashop/nbashop?ac=backexit">安全退出</a></li>
                        </ul>
                    </li>
                    
                </ul>
                <a class="brand" href="admin/index.jsp"><span class="first">球队周边商城后台管理系统</span> <!--  <span class="second">Company</span>--></a>
        </div>
    </div>
