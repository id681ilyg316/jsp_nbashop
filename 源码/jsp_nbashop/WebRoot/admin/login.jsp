  ...
  <body class="">
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="admin/login.jsp"><span class="first">球队周边商城后台管理系统</span> <!--  <span class="second">Company</span>--></a>
        </div>
    </div>
	...
	<%}%>
        <div class="block">
            ...
            <div class="block-body">
                <form action="/nbashop/nbashop?ac=login" method="post">
                    <label>用户名</label>
