...
<html lang="en">
  <head>
	...
	<script charset="utf-8" src="/nbashop/kindeditor/kindeditor.js"></script>
	<script charset="utf-8" src="/nbashop/kindeditor/lang/zh-CN.js"></script>
	<script>
...
uploadJson : '/nbashop/kindeditor/jsp/upload_json.jsp',

                fileManagerJson : '/nbashop/kindeditor/jsp/file_manager_json.jsp',
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/nbashop/nbashop?ac=goodsedit&id=<%=id %>" enctype="multipart/form-data">
		        <label>商品名称</label>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
	    ...
	    function Change_Select(){//当第一个下拉框的选项发生改变时调用该函数
	      ...
	      var url = "/nbashop/nbashop?ac=searchsontype&fprotype="+ escape(fprotype);
