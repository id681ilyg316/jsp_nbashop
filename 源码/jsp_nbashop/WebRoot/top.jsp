...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="/nbashop/admin" target="_blank" ><span
						...
						<li><a href="#" role="button" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1"
									href="/nbashop/nbashop?ac=frontexit"><i
										class="glyphicon glyphicon-log-out"></i>安全退出</a>
								</li>
								<li><a target="_blank" href="/nbashop/admin"><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
							</ul></li>
						<%
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo">
					<span style="font-size:25px">NBA球衣及其周边销售商城</span>
				</div>
			</div>
			<div class="col-md-4">
